...
public class AddressBook {
    ...
    private static void showWelcomeMessage() {
        String[] welcomeMessageArr = {DIVIDER, DIVIDER, VERSION, MESSAGE_WELCOME, DIVIDER};
        showToUser(welcomeMessageArr);
    }

    private static void showResultToUser(String result) {
        String[] resultsArr = {result, DIVIDER};
        showToUser(resultsArr);
    }
    ...
    private static void echoUserCommand(String userCommand) {
        String[] userCommandArr = {"[Command entered:" + userCommand + "]"};
        showToUser(userCommandArr);
    }
    ...
    private static void processProgramArgs(String[] args) {
        if (args.length >= 2) {
            String[] invalidMessageArr = {MESSAGE_INVALID_PROGRAM_ARGS};
            showToUser(invalidMessageArr);
            exitProgram();
        }
    ...
    private static void setupGivenFileForStorage(String filePath) {
        ...
        if (!isValidFilePath(filePath)) {
            String[] invalidFileArr = {String.format(MESSAGE_INVALID_FILE, filePath)};
            showToUser(invalidFileArr);
            exitProgram();
        }
    ...
    private static void exitProgram() {
        String[] exitProgramMessageArr = {MESSAGE_GOODBYE, DIVIDER, DIVIDER};
        showToUser(exitProgramMessageArr);
        System.exit(0);
    }
    ...
    private static void setupDefaultFileForStorage() {
        String[] defaultFileStorageMessageArr = {MESSAGE_USING_DEFAULT_FILE};
        showToUser(defaultFileStorageMessageArr);
    ...
    */
    ...
    private static void showToUser(ArrayList<HashMap<PersonProperty, String>> persons) {
        ...
        String[] listAsStringArr = {listAsString};
        showToUser(listAsStringArr);
    ...
    private static void createFileIfMissing(String filePath) {
        ...
        String[] missingStorageFileErrorMessageArr = {String.format(MESSAGE_ERROR_MISSING_STORAGE_FILE, filePath)};
        showToUser(missingStorageFileErrorMessageArr);

        try {
            storageFile.createNewFile();
            String[] storageFileCreatedMessageArr = {String.format(MESSAGE_STORAGE_FILE_CREATED, filePath)};
            showToUser(storageFileCreatedMessageArr);
        } catch (IOException ioe) {
            String[] storageFileCreatedErrorMessageArr = {String.format(MESSAGE_ERROR_CREATING_STORAGE_FILE, filePath)};
            showToUser(storageFileCreatedErrorMessageArr);
            exitProgram();
        }
    }
    ...
    private static ArrayList<HashMap<PersonProperty, String>> loadPersonsFromFile(String filePath) {
        ...
        if (!successfullyDecoded.isPresent()) {
            String[] invalidStorageFileContentMessageArr = {MESSAGE_INVALID_STORAGE_FILE_CONTENT};
            showToUser(invalidStorageFileContentMessageArr);
            exitProgram();
        }
    ...
    private static ArrayList<String> getLinesInFile(String filePath) {
        ...
        try {
            ...
            String[] missingStorageFileMessageArr = {String.format(MESSAGE_ERROR_MISSING_STORAGE_FILE, filePath)};
            showToUser(missingStorageFileMessageArr);
            exitProgram();
        } catch (IOException ioe) {
            String[] readingFromFileErrorMessageArr = {String.format(MESSAGE_ERROR_READING_FROM_FILE, filePath)};
            showToUser(readingFromFileErrorMessageArr);
            exitProgram();
        }
        return lines;
    }
    ...
    private static void savePersonsToFile(ArrayList<HashMap<PersonProperty, String>> persons, String filePath) {
        ...
        try {
            ...
            String[] writingToFileErrorMessageArr = {String.format(MESSAGE_ERROR_WRITING_TO_FILE, filePath)};
            showToUser(writingToFileErrorMessageArr);
            exitProgram();
        }
    }
